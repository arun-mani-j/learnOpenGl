...
auto main() -> int {
  ...
  auto program = Program(SHADERS_SRC "/exercise_2.vert", SHADERS_SRC "/exercise_2.frag");
  ...
  glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6 * sizeof vertices[0], nullptr);
  ...
  while (glfwWindowShouldClose(window) == 0) {
    ...
    double offsetX = sin(time);
    program.setFloat("offsetX", float(offsetX));
